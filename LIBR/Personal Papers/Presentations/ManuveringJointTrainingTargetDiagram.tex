...
\node[draw, align=center] (NeuralNetwork) [gold, below of=stateEST] {\textbf{LSTM Network} \\ $\hat{z}_{k|k-1}=$ \\ $H_k\hat{x}_{k|k-1}$ };

\node[draw, align=center] (PosteriorState) [red, below of=NeuralNetwork, xshift =  1.5cm] {\textbf{Posterior State} \\ $\hat{x}_{k|k}$ };


% Column 3 - Estimation of the State

\node[draw, align=center] (NeuralNetwork2) [gold, right of=NeuralNetwork, xshift=3cm] {\textbf{LSTM Network} \\ $\hat{z}_{k|k-1}=$ \\ $H_k\hat{x}_{k|k-1}$ };
...
\draw [arrow] (stateEST) -- (NeuralNetwork);
\draw [arrow] (stateEST) -- (NeuralNetwork2);
...
\draw [arrow] (NeuralNetwork) -- (PosteriorState);

\draw [arrow] (NeuralNetwork2) -- (PosteriorState);

...
%In Ohms
omg4=abs(UH4./IH4);
key4 = cell(1,2);key4{1}=["13,42"];key4{2}=["42,31"];
...
%in microA
IH206=zeros(1,4);
IH206(1)=201; IH206(2)=199; IH206(3)=199; IH206(4)=195;
IH206=IH206*10^3; %Convert to mA
%in mV
UH206=zeros(1,4);
UH206(1)=2.6;UH206(2)=-2.4; UH206(3)=1.5;UH206(4)=-1.4;
omg206=abs(UH206./IH206);
%Hpres206 = [key4' num2cell(omg206')];
...
thickness206 = [275 5]*10^-4;                              %m

avgR = errorAdd(vertR,horzR)/2;
...
pres4 = [key4' num2cell(omg4') num2cell(omg206')];

rho4 = errorMultiply(sheetR,thickness4);    %Resistivity Ohm*m
sigma4 = errorPow(rho4,-1);                %Conductivity Ohm^-1 m^-1
